...
usage() {
	...
	echo "            \"base\": <slab base>}"
	echo ""
	echo "           The commands get and put a slab from or to the "
	...
	echo "           purposes."
	echo ""
	echo "           The get command expects the following response:"
	echo "           {\"status\": \"OK\", \"in_bytes\": <bytes>}"
	echo ""
	echo "           The put command expects the following response:"
	echo "           {\"status\": \"OK\", \"out_bytes\": <bytes>}"
}
